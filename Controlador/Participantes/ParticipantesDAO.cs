...
namespace Controlador.Participantes
{
    public class ParticipantesDAO
    {
        ...
        private DataTable listaDatos = null;
        ...
        public void GuardarCambiosParticipantesSinPais()
        {
            try
            {
                clsDatos = new ClsDatos();
                ...
                clsDatos.EjecutarSP(parametro, "spGuardarCambiosParticipantesSINPais");
        ...
        public void GuardarCambiosParticipantesConPais()
        {
            try
            {
                ...
                parametro[3] = new SqlParameter();
                parametro[3].ParameterName = "@pais";
                parametro[3].SqlDbType = SqlDbType.Int;
                parametro[3].SqlValue = participantesDTO.getPais();
